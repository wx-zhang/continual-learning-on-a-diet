...
parser.add_argument('--root', default='data_folder/cloc', metavar='DIR', help='path to dataset')
parser.add_argument('--benchmark', default='data_folder/cloc_split', metavar='DIR', help='Path to save benchmark')
parser.add_argument('--split', default=20, type=int, help='Number of splits')
parser.add_argument('--label_rate', default=0.005, type=float, help='Label rate')
